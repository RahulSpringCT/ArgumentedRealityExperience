...
//server = "ws://172.24.12.156:8188/janus"; //this janus installed on remote
server = "http://127.0.0.1:8088/janus"; //locally installed janus on docker
							...
							janus.attach(
								{
									...
									onlocalstream: function (stream) {
										...
										console.log("...rtpForward : ", rtpForward);
										console.log("....STREAM : ", rtpForward.streams);
